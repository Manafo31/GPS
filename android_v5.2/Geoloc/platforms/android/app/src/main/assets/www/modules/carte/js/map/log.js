...
var localisaiton=undefined;
var map=undefined;
var monJson = undefined;
var usersLastPosition=undefined;
...
var socket = io.connect('http://cdi.afpa-balma.fr:8080');
//var socket = io.connect('http://10.114.129.69:8080');
var server = {
    gps: {
